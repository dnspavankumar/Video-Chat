...
const RootLayout = ({ children }: Readonly<{children: ReactNode}>) => {
  return (
    <main className="relative min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="fixed top-20 left-20 w-72 h-72 bg-gradient-to-r from-red-500/10 to-purple-500/10 rounded-full blur-3xl animate-pulse" />
      <div className="fixed bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-full blur-3xl animate-pulse delay-1000" />
      ...
      <div className="flex relative z-10">
        ...
        <section className="flex-1 min-h-screen lg:ml-[280px]">
          <div className="max-w-7xl mx-auto px-8 py-8 pt-32 lg:px-12">
